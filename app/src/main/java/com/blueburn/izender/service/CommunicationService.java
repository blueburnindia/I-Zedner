package com.blueburn.izender.service;
...
import com.blueburn.izender.app.Service;
import com.blueburn.izender.database.AccessDatabase;
import com.blueburn.izender.exception.AssigneeNotFoundException;
import com.blueburn.izender.exception.ConnectionNotFoundException;
import com.blueburn.izender.exception.DeviceNotFoundException;
import com.blueburn.izender.exception.TransferGroupNotFoundException;
import com.blueburn.izender.fragment.FileListFragment;
...
import com.blueburn.izender.object.TextStreamObject;
import com.blueburn.izender.object.TransferGroup;
import com.blueburn.izender.object.TransferInstance;
import com.blueburn.izender.object.TransferObject;
import com.blueburn.izender.util.AppUtils;
import com.blueburn.izender.util.CommunicationBridge;
import com.blueburn.izender.util.CommunicationNotificationHelper;
import com.blueburn.izender.util.DynamicNotification;
import com.blueburn.izender.util.FileUtils;
import com.blueburn.izender.util.HotspotUtils;
import com.blueburn.izender.util.NetworkDeviceLoader;
import com.blueburn.izender.util.NetworkUtils;
import com.blueburn.izender.util.NotificationUtils;
import com.blueburn.izender.util.NsdDiscovery;
import com.blueburn.izender.util.TimeUtils;
import com.blueburn.izender.util.TransferUtils;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.genonbeta.izender.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.genonbeta.izender.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.genonbeta.izender.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.genonbeta.izender.action.IP";
    public static final String ACTION_END_SESSION = "com.genonbeta.izender.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.genonbeta.izender.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.genonbeta.izender.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.genonbeta.izender.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.genonbeta.izender.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.genonbeta.izender.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.genonbeta.izender.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.genonbeta.izender.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.genonbeta.izender.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.genonbeta.izender.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.genonbeta.izender.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.genonbeta.izender.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.genonbeta.izender.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.genonbeta.izender.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.genonbeta.izender.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.genonbeta.izender.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.genonbeta.izender.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.genonbeta.izender.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.genonbeta.izender.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.genonbeta.izender.transaction.action.REQUEST_WEBSHARE_STATUS";
