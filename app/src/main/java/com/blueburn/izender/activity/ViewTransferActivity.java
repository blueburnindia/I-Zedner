package com.blueburn.izender.activity;
...
import com.blueburn.izender.app.Activity;
import com.blueburn.izender.database.AccessDatabase;
import com.blueburn.izender.fragment.TransferFileExplorerFragment;
import com.blueburn.izender.ui.callback.PowerfulActionModeSupport;
import com.blueburn.izender.R;
import com.blueburn.izender.dialog.EstablishConnectionDialog;
import com.blueburn.izender.dialog.SelectAssigneeDialog;
import com.blueburn.izender.dialog.ToggleMultipleTransferDialog;
import com.blueburn.izender.dialog.TransferInfoDialog;
import com.blueburn.izender.object.NetworkDevice;
import com.blueburn.izender.object.ShowingAssignee;
import com.blueburn.izender.object.TransferGroup;
import com.blueburn.izender.object.TransferObject;
import com.blueburn.izender.service.CommunicationService;
import com.blueburn.izender.util.AppUtils;
import com.blueburn.izender.util.FileUtils;
import com.blueburn.izender.util.TextUtils;
        ...
        implements PowerfulActionModeSupport, SnackbarSupport
{
    ...
    public static final String ACTION_LIST_TRANSFERS = "com.genonbeta.izender.action.LIST_TRANSFERS";
