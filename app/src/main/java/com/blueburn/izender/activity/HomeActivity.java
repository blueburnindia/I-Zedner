...
import com.blueburn.izender.fragment.HomeFragment;
...
import com.blueburn.izender.dialog.ShareAppDialog;
        ...
        implements NavigationView.OnNavigationItemSelectedListener, PowerfulActionModeSupport
{
    ...
    private void applyAwaitingDrawerAction()
    {
        if (mChosenMenuItemId == 0) {
            ...
            try {
                startActivity(new Intent(this, Class.forName("com.blueburn.izender.activity.DonationActivity")));
