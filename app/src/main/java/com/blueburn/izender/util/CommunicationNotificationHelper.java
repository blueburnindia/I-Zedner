package com.blueburn.izender.util;
...
import com.blueburn.izender.activity.FileExplorerActivity;
...
import com.blueburn.izender.receiver.DialogEventReceiver;
...
public class CommunicationNotificationHelper
{
    ...
    public DynamicNotification notifyConnectionRequest(NetworkDevice device)
    {
        ...
        notification.setSmallIcon(R.drawable.ic_alert_circle_outline_white_24dp_static)
                ...
                .addAction(R.drawable.ic_close_white_24dp_static, getContext().getString(R.string.butn_close), negativeIntent)
